TEST_CASE ("testing MATRIX addVertex()")
{
...
TEST_CASE ("testing MATRIX deleteVertex")
{
...
TEST_CASE ("testing MATRIX addEdge()")
{
    AdjacencyMatrixGraph<int, int> graph;
    graph.addVertex(1, 69);
    graph.addVertex(2, 420);
...
TEST_CASE("testing MATRIX deleteEdge()")
{
    AdjacencyMatrixGraph<int, int> graph;
    graph.addVertex(1, 69);
    graph.addVertex(2, 420);
...
TEST_CASE("testing MATRIX isWeaklyConnected()")
{
...
TEST_CASE("testing MATRIX isStronglyConnected()")
{
...
TEST_CASE("testing MATRIX findDistance()")
{
    AdjacencyMatrixGraph<int, int> graph;
